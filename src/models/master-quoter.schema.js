...
const servicesShema = new Schema({
    ...
    service_type: { type: String, enum: ['entrance', 'restaurant', 'operator','expeditions','experience','guides','hotel','train','transport','gourmet','none'], required: true },  // Tipo del servicio
